          ...
          <header class="rounded-3xl border border-slate-200 bg-white p-4">
            <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
              <div>
                ...
                <p class="mt-1 text-sm text-slate-600">Click an employee to edit on the right. No page reload.</p>
              </div>
              <?php if (admin_can($user, 'manage_employees')): ?>
                <div class="flex flex-wrap gap-2">
                  <button type="button" id="btnAddStaff" class="rounded-2xl px-4 py-2 text-sm font-semibold bg-emerald-500/15 border border-emerald-500/30 text-slate-900 hover:bg-emerald-500/20">Add employee</button>
                  <button type="button" id="btnAddAgency" class="rounded-2xl px-4 py-2 text-sm font-semibold bg-sky-500/15 border border-sky-500/30 text-slate-900 hover:bg-sky-500/20">Add agency</button>
                </div>
              <?php endif; ?>
            </div>
