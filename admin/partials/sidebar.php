...
$items[] = ['href' => admin_url('payroll.php'), 'label' => 'Payroll', 'perm' => 'view_payroll'];
$items[] = ['href' => admin_url('devices.php'), 'label' => 'Devices', 'perm' => 'manage_devices'];
...
<aside class="w-full lg:w-72 shrink-0">
  <div class="rounded-3xl border border-white/10 bg-white/5 p-4">
    ...
    <div class="mt-4 border-t border-white/10 pt-4 flex items-center justify-between">
      ...
      <span class="text-[11px] text-white/40">Device lock: ON</span>
    </div>
  </div>
</aside>
