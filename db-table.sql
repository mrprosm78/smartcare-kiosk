...
INSERT INTO `settings` (`key`, `value`, `updated_at`) VALUES
  ...
  -- Manager pairing code (plain text) — change this per site
  ...
  -- Kiosk runtime tuning (safe to expose via status.php)
  ...
  -- Optional auto-reload (bust cache when you deploy UI changes)
  -- Increment ui_version when you deploy new kiosk.html/js
  ('ui_version', '1', NOW()),
  ('ui_reload_enabled', '0', NOW()),
  ('ui_reload_check_ms', '60000', NOW())
