        ...
        <main class="flex-1 min-w-0">
          ...
          <form class="mt-4 rounded-3xl border border-slate-200 bg-white p-4" method="post">
            ...
            <div class="mt-4 flex gap-2">
              ...
              <a class="rounded-2xl px-4 py-2 text-sm font-semibold bg-white border border-slate-200 text-slate-700 hover:bg-slate-50" href="<?php echo h(admin_url('hr-staff.php')); ?>">Cancel</a>
            </div>
          </form>
        </main>
</div>
