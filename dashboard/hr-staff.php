          ...
          <header class="rounded-3xl border border-slate-200 bg-white p-4">
            ...
            <form class="mt-4 flex flex-col lg:flex-row gap-3" method="get" action="">
              ...
              <div class="flex gap-2">
                ...
                <a class="rounded-2xl px-4 py-2 text-sm font-semibold bg-white border border-slate-200 text-slate-700 hover:bg-slate-50" href="<?php echo h(admin_url('hr-staff.php')); ?>">Reset</a>
              </div>
            </form>
          </header>
                    ...
                    <tr class="border-t border-slate-100">
                      ...
                      <td class="px-4 py-3 text-right">
                        <div class="flex items-center justify-end gap-2">
                          <a class="rounded-2xl px-3 py-1.5 text-xs font-semibold bg-slate-900 text-white hover:bg-slate-800" href="<?php echo h(admin_url('hr-staff-view.php?id=' . (int)$r['id'])); ?>">View</a>
                        </div>
                      </td>
                    </tr>
                  <?php endforeach; ?>
