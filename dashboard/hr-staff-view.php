...
try {
  ...
  $k = $pdo->prepare("SELECT id, hr_staff_id, employee_code, is_active, archived_at, pin_updated_at
          ...
          <div class="flex items-start gap-4">
            ...
            <div class="min-w-0">
              ...
              <div class="mt-2 flex flex-wrap items-center gap-2 text-xs">
                ...
                <?php else: ?>
                  <?php if (isset($kiosk['is_active']) && !(int)$kiosk['is_active']): ?>
                    <span class="inline-flex rounded-full border border-amber-200 bg-amber-50 px-2 py-1 font-semibold text-amber-700">Kiosk ID inactive</span>
                  <?php endif; ?>
                  <?php if (empty($kiosk['pin_updated_at'])): ?>
                    <span class="inline-flex rounded-full border border-amber-200 bg-amber-50 px-2 py-1 font-semibold text-amber-700">PIN not set</span>
                  <?php endif; ?>
                <?php endif; ?>
              </div>
            </div>
