...
<div class="space-y-5 text-[11px]">
            ...
            <ul class="mt-3 space-y-2">
                <?php foreach ($warnings as $w): ?>
                    <li class="flex items-start justify-between gap-3">
                        ...
                        <a href="<?= h(sc_apply_step_url($qsBase, (int)$w['step'])); ?>" class="text-[11px] font-medium text-sc-primary hover:text-blue-700">
                            Fix
                        </a>
                    </li>
                <?php endforeach; ?>
    ...
    <div class="rounded-2xl border border-sc-border bg-white px-4 py-4">
        <div class="flex items-center justify-between gap-3">
            ...
            <a href="<?= h(sc_apply_step_url($qsBase, 1)); ?>" class="text-[11px] font-medium text-sc-primary hover:text-blue-700">Edit</a>
        </div>
    ...
    <div class="rounded-2xl border border-sc-border bg-white px-4 py-4">
        <div class="flex items-center justify-between gap-3">
            ...
            <a href="<?= h(sc_apply_step_url($qsBase, 2)); ?>" class="text-[11px] font-medium text-sc-primary hover:text-blue-700">Edit</a>
        </div>
    ...
    <div class="rounded-2xl border border-sc-border bg-white px-4 py-4">
        <div class="flex items-center justify-between gap-3">
            ...
            <a href="<?= h(sc_apply_step_url($qsBase, 3)); ?>" class="text-[11px] font-medium text-sc-primary hover:text-blue-700">Edit</a>
        </div>
    ...
    <div class="rounded-2xl border border-sc-border bg-white px-4 py-4">
        <div class="flex items-center justify-between gap-3">
            ...
            <a href="<?= h(sc_apply_step_url($qsBase, 4)); ?>" class="text-[11px] font-medium text-sc-primary hover:text-blue-700">Edit</a>
        </div>
